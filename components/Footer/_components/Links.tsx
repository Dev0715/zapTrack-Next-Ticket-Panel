...
const Links = () => {
    return <>
        <div className="flex relative flex-col items-center justify-center w-full h-auto max-w-full mt-0 bg-[#70728F] min-w-0 px-[15px] py-[50px]">
            <div className="flex relative flex-row w-full h-auto max-w-[1260px] shrink min-w-0 p-2">
                <div className="flex-row items-strench justify-center flex-nowrap min-w-0 -ml-8 flex flex-1 self-stretch pointer-none" style={{ width: `calc(100% + 32px)` }}>
                    <div className="ml-8 flex relative flex-col h-auto max-w-full justify-start items-center min-w-0 p-2" style={{ width: `calc((100% - 2* 32px)* 2 / 12);` }}>
                        <div className="flex w-full h-auto shrink flex-row grow-0 min-w-0 p-0">
                            <div className="items-stretch flex-row flew-nowrap min-w-0 -ml-10 flex flex-1 self-stretch pointer-none" style={{ width: `calc(100% + 40px)` }}>
                                <div className="flex relative flex-col h-auto max-w-full min-w-0 px-2 ml-10">
                                    <div className="flex-col justify-start items-center min-w-0 -mt-4 flex flex-1 self-stretch" style={{ height: `calc(100% + 16px)` }}>
                                        <div className="w-auto h-auto relative object-cover max-w-[98px] shrink-0 overflow-hidden flex-col mt-4">
                                            <img alt="" className="w-auto min-w-full max-w-full h-auto min-h-full block p-0 border-0 m-0" src={`/pic-logo-footer.webp`} />
                                        </div>
                                        <div className="mt-4 relative w-full h-auto max-w-[800px] text-white text-[37px] font-light text-center">TAIGA</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="ml-8 flex relative flex-col h-auto max-w-full justify-start items-center min-w-0 p-2" style={{ width: `calc((100% - 2* 32px)* 10 / 12);` }}>
                        <div className="flex w-full h-auto shrink flex-row grow-0 min-w-0 p-0">
                            <div className="flex flex-1 self-stretch items-stretch flex-row flex-nowrap min-w-0 -ml-10" style={{ width: `calc(100% + 40px)` }}>

...
const KanbanHeader = ({ status, handleAddUserstory, handleAddBulk }: KanbanHeaderProps) => {
    return <>
        <h2 className={`text-[1rem] items-center bg-[#d8dee9] rounded-tl-[4px] rounded-tr-[4px] text-[#5a5b72] flex basis-[292px] grow-0 shrink-0 h-[36px] justify-between mr-[4px] min-h-[36px] max-w-[292px] px-3 relative uppercase duration-100 vtransition-all leading-tight`}>
            ...
            <div className="flex">
                ...
                <button
                    title="Fold column"
                    className="mr-[2px] bg-transparent text-[#70728f] p-1 text-[.875rem] items-center border-0 rounded-[4px] inline-flex justify-center text-center uppercase hidden"
                >
                    <FaAngleLeft />
                </button>
                <button

...
const Navbar = () => {
    ...
    const [eventPopShow, setEventPopShow] = useState(false);
        ...
        <nav className="bg-[#d8dee9] flex h-12 justify-between relative" >
            ...
            <div className="items-center flex baseline">
                ...
                <div className="relative h-full"
                    ...
                    <div className={`px-4 py-2 rounded-2 ${helpPopShow ? 'block' : 'hidden'} block min-w-[260px] absolute top-[3rem] z-[10] bg-[#f9f9fb]`}
                        style={{ boxShadow: '4px 4px 8px rgba(46,52,64,.1)', animation: 'dropdownFade .2s cubic-bezier(.09,0,.99,.01) both' }}>
                        <ul className='mb-0 p-0'>
                            <li >
                                <Link href="#" title="Help center" className="flex items-center px-2 py-[12.8px] text-[#4c566a]">
                                    <FiLifeBuoy className='w-[20px] h-[20px] text-[#008AA8]' />
                            ...
                            <li>
                                <Link href="https://community.taiga.io/" target="_blank" title="Go to Taiga Community" className='text-[#4c566a] flex items-center px-2 py-[12.8px]'>
                                    <FiCommand className='w-[20px] h-[20px] text-[#008AA8]' />
                                    <span className='pl-4'>Taiga Community</span>
                                </Link>
                            </li>
                            <li>
                ...
                <div className="relative h-full"
                    onMouseEnter={() => setEventPopShow(true)}
                    onMouseLeave={() => setEventPopShow(false)}>
                    ...
                    <div className={`bg-[#f9f9fb] rounded-2 ${eventPopShow ? `block` : `hidden`} -left-[355px] p-[1rem] absolute top-[3rem] w-[400px] z-[9]`} style={{ boxShadow: `0 0 3px 3px rgba(169,170,188,.2)` }}>
                        <div className="text-[.7rem] text-[#5a5b72] mb-[0.5rem] text-right">
                            <Link className="text-[#4c566a] lowercase" href={`#`}>Dismiss all</Link>
                        </div>
                        <div className="">
                            <div className="text-[.875rem] text-[#70728f] pl-2 w-full"><span>No new events</span></div>
                            <section className="max-h-[400px]">
                                <div>
                                </div>
                            </section>
                        </div>
                        <div className="text-[.875rem] px-2 pt-4 pb-1 mt-4 border-t border-t-[#83eede] ">
                            <Link className="text-[#008aa8]" href="#">View all notifications</Link>
                        </div>
                    </div>
                </div>
                        ...
                        <div className={`-left-[200px] top-[40px] w-[290px] rounded ${profilePopShow ? 'block' : 'hidden'} min-w-[26px] absolute z-[10] bg-[#f9f9fb] p-4`} style={{ boxShadow: `4px 4px 8px rgba(46,52,64,.1)`, animation: 'dropdownFade .2s cubic-bezier(.09,0,.99,.01) both' }}>
                            <div className="flex mb-2 pb-3 border-b border-b-[#83eede]">
                                <Link href="profile" className="px-2 py-[12.8px] text-[#2e3440]">
                                    <img alt="DevKing"
                                        src="https://www.gravatar.com/avatar/da2797ae8a31569b03809648a66cf9a9?s=200&d=https%3A%2F%2Ftree.taiga.io%2Fv-1708969004480%2Fimages%2Fuser-avatars%2Fuser-avatar-01.png"
                                        title="DevKing"
                                        className="h-[65px] w-[65px] rounded-full border-[2px] border-[#fff] bg-[D2C68B]" />
                                </Link>
                            ...
                            <ul className='mb-0'>
                                ...
                                <li className="border-t border-t-[#83eede] mt-2">
                                    <Link href="#" title="Logout" className='px-2 py-[12.8px] text-[#008aa8] block' onClick={() => handleSignout()}>Logout</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
